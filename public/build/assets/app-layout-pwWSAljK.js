import{r as u,j as c,b as $,t as Mo,R as rs,f as as,e as ss,c as P,a as je,L as _e,d as is}from"./app-BSl0qwY5.js";import{u as G,b as mt,d as vn,e as ls,a as X,c as D,g as Ao,B as cs,h as us,i as Ce}from"./image-Bg0zMWmQ.js";import{b as ye,d as he,u as Xe,c as I,P as ie,e as ds,a as fs}from"./index-DVbpVd4L.js";import{P as H,d as Oo}from"./index-FWP8a9ph.js";import{X as ps}from"./x-B93R5aWk.js";import{C as Vn}from"./chevron-down-BSwfdyed.js";import{b as ms,d as hs}from"./index-yf8TppwC.js";import{U as gs,S as vs}from"./user-DumlIpwT.js";import{u as ys}from"./config-DLcEUwjG.js";import{F as bs}from"./file-text-wl9DuSA8.js";import{T as xs}from"./tag-CnWzVf9V.js";import{S as ws}from"./star-uo1E1W9X.js";var _s=Object.freeze({position:"absolute",border:0,width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",wordWrap:"normal"}),Cs="VisuallyHidden",Io=u.forwardRef((t,e)=>c.jsx(H.span,{...t,ref:e,style:{..._s,...t.style}}));Io.displayName=Cs;var Es=Io;function ko(t){const e=t+"CollectionProvider",[n,o]=ye(e),[r,a]=n(e,{collectionRef:{current:null},itemMap:new Map}),s=h=>{const{scope:v,children:b}=h,x=$.useRef(null),_=$.useRef(new Map).current;return c.jsx(r,{scope:v,itemMap:_,collectionRef:x,children:b})};s.displayName=e;const i=t+"CollectionSlot",l=mt(i),d=$.forwardRef((h,v)=>{const{scope:b,children:x}=h,_=a(i,b),w=G(v,_.collectionRef);return c.jsx(l,{ref:w,children:x})});d.displayName=i;const f=t+"CollectionItemSlot",p="data-radix-collection-item",m=mt(f),g=$.forwardRef((h,v)=>{const{scope:b,children:x,..._}=h,w=$.useRef(null),E=G(v,w),T=a(f,b);return $.useEffect(()=>(T.itemMap.set(w,{ref:w,..._}),()=>{T.itemMap.delete(w)})),c.jsx(m,{[p]:"",ref:E,children:x})});g.displayName=f;function y(h){const v=a(t+"CollectionConsumer",h);return $.useCallback(()=>{const x=v.collectionRef.current;if(!x)return[];const _=Array.from(x.querySelectorAll(`[${p}]`));return Array.from(v.itemMap.values()).sort((T,C)=>_.indexOf(T.ref.current)-_.indexOf(C.ref.current))},[v.collectionRef,v.itemMap])}return[{Provider:s,Slot:d,ItemSlot:g},y,o]}var Ts=Mo[" useId ".trim().toString()]||(()=>{}),Ss=0;function me(t){const[e,n]=u.useState(Ts());return he(()=>{n(o=>o??String(Ss++))},[t]),t||(e?`radix-${e}`:"")}var Et="Collapsible",[Rs]=ye(Et),[Ns,yn]=Rs(Et),Do=u.forwardRef((t,e)=>{const{__scopeCollapsible:n,open:o,defaultOpen:r,disabled:a,onOpenChange:s,...i}=t,[l,d]=Xe({prop:o,defaultProp:r??!1,onChange:s,caller:Et});return c.jsx(Ns,{scope:n,disabled:a,contentId:me(),open:l,onOpenToggle:u.useCallback(()=>d(f=>!f),[d]),children:c.jsx(H.div,{"data-state":xn(l),"data-disabled":a?"":void 0,...i,ref:e})})});Do.displayName=Et;var jo="CollapsibleTrigger",Lo=u.forwardRef((t,e)=>{const{__scopeCollapsible:n,...o}=t,r=yn(jo,n);return c.jsx(H.button,{type:"button","aria-controls":r.contentId,"aria-expanded":r.open||!1,"data-state":xn(r.open),"data-disabled":r.disabled?"":void 0,disabled:r.disabled,...o,ref:e,onClick:I(t.onClick,r.onOpenToggle)})});Lo.displayName=jo;var bn="CollapsibleContent",$o=u.forwardRef((t,e)=>{const{forceMount:n,...o}=t,r=yn(bn,t.__scopeCollapsible);return c.jsx(ie,{present:n||r.open,children:({present:a})=>c.jsx(Ps,{...o,ref:e,present:a})})});$o.displayName=bn;var Ps=u.forwardRef((t,e)=>{const{__scopeCollapsible:n,present:o,children:r,...a}=t,s=yn(bn,n),[i,l]=u.useState(o),d=u.useRef(null),f=G(e,d),p=u.useRef(0),m=p.current,g=u.useRef(0),y=g.current,h=s.open||i,v=u.useRef(h),b=u.useRef(void 0);return u.useEffect(()=>{const x=requestAnimationFrame(()=>v.current=!1);return()=>cancelAnimationFrame(x)},[]),he(()=>{const x=d.current;if(x){b.current=b.current||{transitionDuration:x.style.transitionDuration,animationName:x.style.animationName},x.style.transitionDuration="0s",x.style.animationName="none";const _=x.getBoundingClientRect();p.current=_.height,g.current=_.width,v.current||(x.style.transitionDuration=b.current.transitionDuration,x.style.animationName=b.current.animationName),l(o)}},[s.open,o]),c.jsx(H.div,{"data-state":xn(s.open),"data-disabled":s.disabled?"":void 0,id:s.contentId,hidden:!h,...a,ref:f,style:{"--radix-collapsible-content-height":m?`${m}px`:void 0,"--radix-collapsible-content-width":y?`${y}px`:void 0,...t.style},children:h&&r})});function xn(t){return t?"open":"closed"}var Ms=Do,As=u.createContext(void 0);function Fo(t){const e=u.useContext(As);return t||e||"ltr"}function se(t){const e=u.useRef(t);return u.useEffect(()=>{e.current=t}),u.useMemo(()=>(...n)=>e.current?.(...n),[])}function Os(t,e=globalThis?.document){const n=se(t);u.useEffect(()=>{const o=r=>{r.key==="Escape"&&n(r)};return e.addEventListener("keydown",o,{capture:!0}),()=>e.removeEventListener("keydown",o,{capture:!0})},[n,e])}var Is="DismissableLayer",on="dismissableLayer.update",ks="dismissableLayer.pointerDownOutside",Ds="dismissableLayer.focusOutside",Xn,Bo=u.createContext({layers:new Set,layersWithOutsidePointerEventsDisabled:new Set,branches:new Set}),Tt=u.forwardRef((t,e)=>{const{disableOutsidePointerEvents:n=!1,onEscapeKeyDown:o,onPointerDownOutside:r,onFocusOutside:a,onInteractOutside:s,onDismiss:i,...l}=t,d=u.useContext(Bo),[f,p]=u.useState(null),m=f?.ownerDocument??globalThis?.document,[,g]=u.useState({}),y=G(e,C=>p(C)),h=Array.from(d.layers),[v]=[...d.layersWithOutsidePointerEventsDisabled].slice(-1),b=h.indexOf(v),x=f?h.indexOf(f):-1,_=d.layersWithOutsidePointerEventsDisabled.size>0,w=x>=b,E=$s(C=>{const S=C.target,N=[...d.branches].some(R=>R.contains(S));!w||N||(r?.(C),s?.(C),C.defaultPrevented||i?.())},m),T=Fs(C=>{const S=C.target;[...d.branches].some(R=>R.contains(S))||(a?.(C),s?.(C),C.defaultPrevented||i?.())},m);return Os(C=>{x===d.layers.size-1&&(o?.(C),!C.defaultPrevented&&i&&(C.preventDefault(),i()))},m),u.useEffect(()=>{if(f)return n&&(d.layersWithOutsidePointerEventsDisabled.size===0&&(Xn=m.body.style.pointerEvents,m.body.style.pointerEvents="none"),d.layersWithOutsidePointerEventsDisabled.add(f)),d.layers.add(f),Yn(),()=>{n&&d.layersWithOutsidePointerEventsDisabled.size===1&&(m.body.style.pointerEvents=Xn)}},[f,m,n,d]),u.useEffect(()=>()=>{f&&(d.layers.delete(f),d.layersWithOutsidePointerEventsDisabled.delete(f),Yn())},[f,d]),u.useEffect(()=>{const C=()=>g({});return document.addEventListener(on,C),()=>document.removeEventListener(on,C)},[]),c.jsx(H.div,{...l,ref:y,style:{pointerEvents:_?w?"auto":"none":void 0,...t.style},onFocusCapture:I(t.onFocusCapture,T.onFocusCapture),onBlurCapture:I(t.onBlurCapture,T.onBlurCapture),onPointerDownCapture:I(t.onPointerDownCapture,E.onPointerDownCapture)})});Tt.displayName=Is;var js="DismissableLayerBranch",Ls=u.forwardRef((t,e)=>{const n=u.useContext(Bo),o=u.useRef(null),r=G(e,o);return u.useEffect(()=>{const a=o.current;if(a)return n.branches.add(a),()=>{n.branches.delete(a)}},[n.branches]),c.jsx(H.div,{...t,ref:r})});Ls.displayName=js;function $s(t,e=globalThis?.document){const n=se(t),o=u.useRef(!1),r=u.useRef(()=>{});return u.useEffect(()=>{const a=i=>{if(i.target&&!o.current){let l=function(){zo(ks,n,d,{discrete:!0})};const d={originalEvent:i};i.pointerType==="touch"?(e.removeEventListener("click",r.current),r.current=l,e.addEventListener("click",r.current,{once:!0})):l()}else e.removeEventListener("click",r.current);o.current=!1},s=window.setTimeout(()=>{e.addEventListener("pointerdown",a)},0);return()=>{window.clearTimeout(s),e.removeEventListener("pointerdown",a),e.removeEventListener("click",r.current)}},[e,n]),{onPointerDownCapture:()=>o.current=!0}}function Fs(t,e=globalThis?.document){const n=se(t),o=u.useRef(!1);return u.useEffect(()=>{const r=a=>{a.target&&!o.current&&zo(Ds,n,{originalEvent:a},{discrete:!1})};return e.addEventListener("focusin",r),()=>e.removeEventListener("focusin",r)},[e,n]),{onFocusCapture:()=>o.current=!0,onBlurCapture:()=>o.current=!1}}function Yn(){const t=new CustomEvent(on);document.dispatchEvent(t)}function zo(t,e,n,{discrete:o}){const r=n.originalEvent.target,a=new CustomEvent(t,{bubbles:!1,cancelable:!0,detail:n});e&&r.addEventListener(t,e,{once:!0}),o?Oo(r,a):r.dispatchEvent(a)}var Ht="focusScope.autoFocusOnMount",Ut="focusScope.autoFocusOnUnmount",qn={bubbles:!1,cancelable:!0},Bs="FocusScope",wn=u.forwardRef((t,e)=>{const{loop:n=!1,trapped:o=!1,onMountAutoFocus:r,onUnmountAutoFocus:a,...s}=t,[i,l]=u.useState(null),d=se(r),f=se(a),p=u.useRef(null),m=G(e,h=>l(h)),g=u.useRef({paused:!1,pause(){this.paused=!0},resume(){this.paused=!1}}).current;u.useEffect(()=>{if(o){let h=function(_){if(g.paused||!i)return;const w=_.target;i.contains(w)?p.current=w:pe(p.current,{select:!0})},v=function(_){if(g.paused||!i)return;const w=_.relatedTarget;w!==null&&(i.contains(w)||pe(p.current,{select:!0}))},b=function(_){if(document.activeElement===document.body)for(const E of _)E.removedNodes.length>0&&pe(i)};document.addEventListener("focusin",h),document.addEventListener("focusout",v);const x=new MutationObserver(b);return i&&x.observe(i,{childList:!0,subtree:!0}),()=>{document.removeEventListener("focusin",h),document.removeEventListener("focusout",v),x.disconnect()}}},[o,i,g.paused]),u.useEffect(()=>{if(i){Qn.add(g);const h=document.activeElement;if(!i.contains(h)){const b=new CustomEvent(Ht,qn);i.addEventListener(Ht,d),i.dispatchEvent(b),b.defaultPrevented||(zs(Ks(Wo(i)),{select:!0}),document.activeElement===h&&pe(i))}return()=>{i.removeEventListener(Ht,d),setTimeout(()=>{const b=new CustomEvent(Ut,qn);i.addEventListener(Ut,f),i.dispatchEvent(b),b.defaultPrevented||pe(h??document.body,{select:!0}),i.removeEventListener(Ut,f),Qn.remove(g)},0)}}},[i,d,f,g]);const y=u.useCallback(h=>{if(!n&&!o||g.paused)return;const v=h.key==="Tab"&&!h.altKey&&!h.ctrlKey&&!h.metaKey,b=document.activeElement;if(v&&b){const x=h.currentTarget,[_,w]=Ws(x);_&&w?!h.shiftKey&&b===w?(h.preventDefault(),n&&pe(_,{select:!0})):h.shiftKey&&b===_&&(h.preventDefault(),n&&pe(w,{select:!0})):b===x&&h.preventDefault()}},[n,o,g.paused]);return c.jsx(H.div,{tabIndex:-1,...s,ref:m,onKeyDown:y})});wn.displayName=Bs;function zs(t,{select:e=!1}={}){const n=document.activeElement;for(const o of t)if(pe(o,{select:e}),document.activeElement!==n)return}function Ws(t){const e=Wo(t),n=Zn(e,t),o=Zn(e.reverse(),t);return[n,o]}function Wo(t){const e=[],n=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode:o=>{const r=o.tagName==="INPUT"&&o.type==="hidden";return o.disabled||o.hidden||r?NodeFilter.FILTER_SKIP:o.tabIndex>=0?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}});for(;n.nextNode();)e.push(n.currentNode);return e}function Zn(t,e){for(const n of t)if(!Hs(n,{upTo:e}))return n}function Hs(t,{upTo:e}){if(getComputedStyle(t).visibility==="hidden")return!0;for(;t;){if(e!==void 0&&t===e)return!1;if(getComputedStyle(t).display==="none")return!0;t=t.parentElement}return!1}function Us(t){return t instanceof HTMLInputElement&&"select"in t}function pe(t,{select:e=!1}={}){if(t&&t.focus){const n=document.activeElement;t.focus({preventScroll:!0}),t!==n&&Us(t)&&e&&t.select()}}var Qn=Gs();function Gs(){let t=[];return{add(e){const n=t[0];e!==n&&n?.pause(),t=Jn(t,e),t.unshift(e)},remove(e){t=Jn(t,e),t[0]?.resume()}}}function Jn(t,e){const n=[...t],o=n.indexOf(e);return o!==-1&&n.splice(o,1),n}function Ks(t){return t.filter(e=>e.tagName!=="A")}var Vs="Portal",St=u.forwardRef((t,e)=>{const{container:n,...o}=t,[r,a]=u.useState(!1);he(()=>a(!0),[]);const s=n||r&&globalThis?.document?.body;return s?rs.createPortal(c.jsx(H.div,{...o,ref:e}),s):null});St.displayName=Vs;var Gt=0;function Ho(){u.useEffect(()=>{const t=document.querySelectorAll("[data-radix-focus-guard]");return document.body.insertAdjacentElement("afterbegin",t[0]??eo()),document.body.insertAdjacentElement("beforeend",t[1]??eo()),Gt++,()=>{Gt===1&&document.querySelectorAll("[data-radix-focus-guard]").forEach(e=>e.remove()),Gt--}},[])}function eo(){const t=document.createElement("span");return t.setAttribute("data-radix-focus-guard",""),t.tabIndex=0,t.style.outline="none",t.style.opacity="0",t.style.position="fixed",t.style.pointerEvents="none",t}var oe=function(){return oe=Object.assign||function(e){for(var n,o=1,r=arguments.length;o<r;o++){n=arguments[o];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},oe.apply(this,arguments)};function Uo(t,e){var n={};for(var o in t)Object.prototype.hasOwnProperty.call(t,o)&&e.indexOf(o)<0&&(n[o]=t[o]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,o=Object.getOwnPropertySymbols(t);r<o.length;r++)e.indexOf(o[r])<0&&Object.prototype.propertyIsEnumerable.call(t,o[r])&&(n[o[r]]=t[o[r]]);return n}function Xs(t,e,n){if(n||arguments.length===2)for(var o=0,r=e.length,a;o<r;o++)(a||!(o in e))&&(a||(a=Array.prototype.slice.call(e,0,o)),a[o]=e[o]);return t.concat(a||Array.prototype.slice.call(e))}var ut="right-scroll-bar-position",dt="width-before-scroll-bar",Ys="with-scroll-bars-hidden",qs="--removed-body-scroll-bar-size";function Kt(t,e){return typeof t=="function"?t(e):t&&(t.current=e),t}function Zs(t,e){var n=u.useState(function(){return{value:t,callback:e,facade:{get current(){return n.value},set current(o){var r=n.value;r!==o&&(n.value=o,n.callback(o,r))}}}})[0];return n.callback=e,n.facade}var Qs=typeof window<"u"?u.useLayoutEffect:u.useEffect,to=new WeakMap;function Js(t,e){var n=Zs(null,function(o){return t.forEach(function(r){return Kt(r,o)})});return Qs(function(){var o=to.get(n);if(o){var r=new Set(o),a=new Set(t),s=n.current;r.forEach(function(i){a.has(i)||Kt(i,null)}),a.forEach(function(i){r.has(i)||Kt(i,s)})}to.set(n,t)},[t]),n}function ei(t){return t}function ti(t,e){e===void 0&&(e=ei);var n=[],o=!1,r={read:function(){if(o)throw new Error("Sidecar: could not `read` from an `assigned` medium. `read` could be used only with `useMedium`.");return n.length?n[n.length-1]:t},useMedium:function(a){var s=e(a,o);return n.push(s),function(){n=n.filter(function(i){return i!==s})}},assignSyncMedium:function(a){for(o=!0;n.length;){var s=n;n=[],s.forEach(a)}n={push:function(i){return a(i)},filter:function(){return n}}},assignMedium:function(a){o=!0;var s=[];if(n.length){var i=n;n=[],i.forEach(a),s=n}var l=function(){var f=s;s=[],f.forEach(a)},d=function(){return Promise.resolve().then(l)};d(),n={push:function(f){s.push(f),d()},filter:function(f){return s=s.filter(f),n}}}};return r}function ni(t){t===void 0&&(t={});var e=ti(null);return e.options=oe({async:!0,ssr:!1},t),e}var Go=function(t){var e=t.sideCar,n=Uo(t,["sideCar"]);if(!e)throw new Error("Sidecar: please provide `sideCar` property to import the right car");var o=e.read();if(!o)throw new Error("Sidecar medium not found");return u.createElement(o,oe({},n))};Go.isSideCarExport=!0;function oi(t,e){return t.useMedium(e),Go}var Ko=ni(),Vt=function(){},Rt=u.forwardRef(function(t,e){var n=u.useRef(null),o=u.useState({onScrollCapture:Vt,onWheelCapture:Vt,onTouchMoveCapture:Vt}),r=o[0],a=o[1],s=t.forwardProps,i=t.children,l=t.className,d=t.removeScrollBar,f=t.enabled,p=t.shards,m=t.sideCar,g=t.noRelative,y=t.noIsolation,h=t.inert,v=t.allowPinchZoom,b=t.as,x=b===void 0?"div":b,_=t.gapMode,w=Uo(t,["forwardProps","children","className","removeScrollBar","enabled","shards","sideCar","noRelative","noIsolation","inert","allowPinchZoom","as","gapMode"]),E=m,T=Js([n,e]),C=oe(oe({},w),r);return u.createElement(u.Fragment,null,f&&u.createElement(E,{sideCar:Ko,removeScrollBar:d,shards:p,noRelative:g,noIsolation:y,inert:h,setCallbacks:a,allowPinchZoom:!!v,lockRef:n,gapMode:_}),s?u.cloneElement(u.Children.only(i),oe(oe({},C),{ref:T})):u.createElement(x,oe({},C,{className:l,ref:T}),i))});Rt.defaultProps={enabled:!0,removeScrollBar:!0,inert:!1};Rt.classNames={fullWidth:dt,zeroRight:ut};var ri=function(){if(typeof __webpack_nonce__<"u")return __webpack_nonce__};function ai(){if(!document)return null;var t=document.createElement("style");t.type="text/css";var e=ri();return e&&t.setAttribute("nonce",e),t}function si(t,e){t.styleSheet?t.styleSheet.cssText=e:t.appendChild(document.createTextNode(e))}function ii(t){var e=document.head||document.getElementsByTagName("head")[0];e.appendChild(t)}var li=function(){var t=0,e=null;return{add:function(n){t==0&&(e=ai())&&(si(e,n),ii(e)),t++},remove:function(){t--,!t&&e&&(e.parentNode&&e.parentNode.removeChild(e),e=null)}}},ci=function(){var t=li();return function(e,n){u.useEffect(function(){return t.add(e),function(){t.remove()}},[e&&n])}},Vo=function(){var t=ci(),e=function(n){var o=n.styles,r=n.dynamic;return t(o,r),null};return e},ui={left:0,top:0,right:0,gap:0},Xt=function(t){return parseInt(t||"",10)||0},di=function(t){var e=window.getComputedStyle(document.body),n=e[t==="padding"?"paddingLeft":"marginLeft"],o=e[t==="padding"?"paddingTop":"marginTop"],r=e[t==="padding"?"paddingRight":"marginRight"];return[Xt(n),Xt(o),Xt(r)]},fi=function(t){if(t===void 0&&(t="margin"),typeof window>"u")return ui;var e=di(t),n=document.documentElement.clientWidth,o=window.innerWidth;return{left:e[0],top:e[1],right:e[2],gap:Math.max(0,o-n+e[2]-e[0])}},pi=Vo(),Oe="data-scroll-locked",mi=function(t,e,n,o){var r=t.left,a=t.top,s=t.right,i=t.gap;return n===void 0&&(n="margin"),`
  .`.concat(Ys,` {
...
`,Po=new Map,Xp=(t,e)=>{Ja(()=>{if(typeof document>"u")return;let n=document,o=Po.get(n);if(o){e&&o.setAttribute("nonce",e);return}let r=n.createElement("style");r.textContent=t,e&&r.setAttribute("nonce",e),n.head.appendChild(r),Po.set(n,r)},[e])};function Yp(t){return Xp(Vp,t.nonce),$.createElement(Kp,{...t})}function qp(){const t=P.c(7),{props:e}=je();let n;t[0]!==e.flash?(n=e.flash||{success:"",error:""},t[0]=e.flash,t[1]=n):n=t[1];const o=n;let r,a;t[2]!==o.error||t[3]!==o.success?(r=()=>{o.success&&z.success(o.success),o.error&&z.error(o.error)},a=[o.success,o.error],t[2]=o.error,t[3]=o.success,t[4]=r,t[5]=a):(r=t[4],a=t[5]),u.useEffect(r,a);let s;return t[6]===Symbol.for("react.memo_cache_sentinel")?(s=c.jsx(Yp,{position:"top-right",autoClose:5500,hideProgressBar:!1,newestOnTop:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,theme:"light"}),t[6]=s):s=t[6],s}const fm=({children:t,breadcrumbs:e,recentOrders:n,...o})=>c.jsxs(c.Fragment,{children:[c.jsx(qp,{}),c.jsx(pp,{breadcrumbs:e,recentOrders:n,...o,children:t})]});export{fm as A,Gd as B,$r as C,Of as D,wn as F,_d as K,Rd as M,Ui as O,St as P,jr as R,Dd as S,Ki as T,_o as U,_s as V,If as a,kf as b,nn as c,me as d,Lr as e,It as f,ko as g,Qo as h,Ho as i,_n as j,Tt as k,se as l,Fr as m,fd as n,ud as o,Hn as p,Vi as q,qi as r,Wi as s,Gi as t,Fo as u,Xi as v,um as w,Hi as x,Ad as y};
