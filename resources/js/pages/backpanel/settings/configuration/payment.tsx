...
export default function PaymentConfiguration({ configurations, currentGroup }: Props) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      href: '/cpanel/settings/configuration/payment',
    },
  ];
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <SettingsLayout>
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Form Konfigurasi Pembayaran</CardTitle>
              <CardDescription>
          ...
          {configurations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Daftar Konfigurasi Pembayaran</CardTitle>
                <CardDescription>
                  Lihat dan kelola semua konfigurasi pembayaran
                </CardDescription>
              </CardHeader>
              <CardContent>
              <Table>
