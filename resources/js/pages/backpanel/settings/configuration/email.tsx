...
export default function EmailConfiguration({ configurations, currentGroup }: Props) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      href: '/cpanel/settings/configuration/email',
    },
  ];
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <SettingsLayout>
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Form Konfigurasi Email</CardTitle>
              <CardDescription>
                Perbarui pengaturan email dan SMTP sistem
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {configurations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Daftar Konfigurasi Email</CardTitle>
                <CardDescription>
                  Lihat dan kelola semua konfigurasi email
                </CardDescription>
              </CardHeader>
              <CardContent>
              <Table>
