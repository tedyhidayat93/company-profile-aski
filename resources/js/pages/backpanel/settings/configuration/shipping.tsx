...
export default function ShippingConfiguration({ configurations, currentGroup }: Props) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      href: '/cpanel/settings/configuration/shipping',
    },
  ];
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <SettingsLayout>
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Form Konfigurasi Pengiriman</CardTitle>
              <CardDescription>
                Perbarui pengaturan metode pengiriman
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {configurations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Daftar Konfigurasi Pengiriman</CardTitle>
                <CardDescription>
                  Lihat dan kelola semua konfigurasi pengiriman
                </CardDescription>
              </CardHeader>
              <CardContent>
              <Table>
