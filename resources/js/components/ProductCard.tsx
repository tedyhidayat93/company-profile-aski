...
export default function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        <div  onClick={() => window.location.href=`/katalog/${product.slug}`} className="group relative flex flex-col overflow-hidden rounded-2xl bg-white dark:bg-slate-900 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            {/* Image */}
